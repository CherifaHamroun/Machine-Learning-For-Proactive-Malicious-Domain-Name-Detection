...
if __name__ == '__main__':
	...
	domains = list_phish + list_dgas + list_spams + list_gandi_selled_white + list_alexa_white
	print("Total domains of : ",len(domains))
	print("Total phishing of : ",len(list_phish))
	print("Total dgas of : ",len(list_dgas))
	print("Total spams of : ",len(list_spams))
	classes = [1] * (len(list_phish) +len(list_dgas)+ len(list_spams)) + [0]*(len(list_alexa_white)+len(list_gandi_selled_white))
	...
	df['class'] = classes
	df.to_csv('all_domains_with_textual_attributes.csv')
