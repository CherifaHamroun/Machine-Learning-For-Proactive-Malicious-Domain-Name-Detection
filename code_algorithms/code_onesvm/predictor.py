...
if __name__=='__main__':
	...
	onesvm_from_pickle_alexa = pickle.load(open("./models_alikeness/onesvm_alexa_alike.pkl", "rb"))
	onesvm_from_pickle_gandi_selled = pickle.load(open("./models_alikeness/onesvm_gandi_selled_alike.pkl", "rb"))
	onesvm_from_pickle_phishing = pickle.load(open("./models_alikeness/onesvm_phish_alike.pkl", "rb"))
	onesvm_from_pickle_spams = pickle.load(open("./models_alikeness/onesvm_spam_alike.pkl", "rb"))
	onesvm_from_pickle_dgas = pickle.load(open("./models_alikeness/onesvm_dga_alike.pkl", "rb"))
	onesvm_from_pickle_gandi_non_value = pickle.load(open("./models_alikeness/onesvm_gandi_non_value_alike.pkl", "rb"))
